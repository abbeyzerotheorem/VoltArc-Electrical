  ...
  return (
    <section className="bg-slate-50 content-visibility-auto">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20">
        ...
        <FadeIn delay={0.1}>
          <div className="mx-auto max-w-sm mb-10 rounded-xl border border-slate-200 bg-white p-5 flex items-center gap-4 shadow-card">
        ...
        <div className="relative">
          <div
            ref={scrollRef}
            className="flex gap-6 overflow-x-auto snap-x snap-mandatory pb-4 no-scrollbar -mx-4 px-4 sm:mx-0 sm:px-0 sm:overflow-visible sm:grid sm:grid-cols-2 sm:gap-6 sm:snap-none"
          >
            {config.testimonials.map((testimonial) => (
              ...
              >
                <div className="h-full rounded-xl border border-slate-200 bg-white p-6 transition-all duration-300 hover:border-slate-300 hover:shadow-card-hover">
